...
void refresh_clocks(global_s *all)
{
    ...
    all->sprite.game.cl.cl_1.seconds = all->sprite.game.cl.cl_1.tms / 1000000.0;
    all->sprite.game.cl.cl_2.time = sfcget(all->sprite.game.cl.cl_2.clock);
    all->sprite.game.cl.cl_2.seconds = all->sprite.game.cl.cl_2.tms / 1000000.0;
    all->sprite.game.cl.cl_3.time = sfcget(all->sprite.game.cl.cl_3.clock);
    all->sprite.game.cl.cl_3.seconds = all->sprite.game.cl.cl_3.tms / 1000000.0;
    all->sprite.game.cl.cl_4.time = sfcget(all->sprite.game.cl.cl_4.clock);
    all->sprite.game.cl.cl_4.seconds = all->sprite.game.cl.cl_4.tms / 1000000.0;
    all->sprite.game.cl.cl_5.time = sfcget(all->sprite.game.cl.cl_5.clock);
    all->sprite.game.cl.cl_5.seconds = all->sprite.game.cl.cl_5.tms / 1000000.0;
    all->sprite.game.cl.cl_6.time = sfcget(all->sprite.game.cl.cl_6.clock);
    all->sprite.game.cl.cl_6.seconds = all->sprite.game.cl.cl_6.tms / 1000000.0;
    all->sprite.game.cl.cl_7.time = sfcget(all->sprite.game.cl.cl_7.clock);
    all->sprite.game.cl.cl_7.seconds = all->sprite.game.cl.cl_7.tms / 1000000.0;
    all->sprite.game.cl.cl_8.time = sfcget(all->sprite.game.cl.cl_8.clock);
    all->sprite.game.cl.cl_8.seconds = all->sprite.game.cl.cl_8.tms / 1000000.0;
}